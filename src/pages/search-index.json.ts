...
export const GET: APIRoute = async () => {
  ...
  for (const b of [
    { slug: 'affiliate-marketing-posting-sites', title: 'Affiliate Marketing Posting Sites: 100 Places to Publish', desc: 'Affiliate Marketing Posting Sites - 100 live sites for guest posts and contributions, with DR, DA and traffic.', kw: 'affiliate marketing posting sites guest post sites write for us link building' },
    { slug: 'yoga-posting-sites', title: 'Yoga Posting Sites: 100 Places to Publish', desc: 'Yoga Posting Sites - 100 live sites for guest posts and contributions, with DR, DA and traffic.', kw: 'yoga posting sites guest post sites write for us link building' },
    { slug: 'social-media-posting-sites', title: 'Social Media Posting Sites: 100 Places to Publish', desc: 'Social Media Posting Sites - 100 live sites for guest posts and contributions, with DR, DA and traffic.', kw: 'social media posting sites guest post sites write for us link building' },
    { slug: 'forex-posting-sites', title: 'Forex Posting Sites: 100 Places to Publish', desc: 'Forex Posting Sites - 100 live sites for guest posts and contributions, with DR, DA and traffic.', kw: 'forex posting sites guest post sites write for us link building' },
    { slug: 'cryptocurrency-posting-sites', title: 'Cryptocurrency Posting Sites: 100 Places to Publish', desc: 'Cryptocurrency Posting Sites - 100 live sites for guest posts and contributions, with DR, DA and traffic.', kw: 'cryptocurrency posting sites guest post sites write for us link building' },
    { slug: 'weight-loss-posting-sites', title: 'Weight Loss Posting Sites: 100 Places to Publish', desc: 'Weight Loss Posting Sites - 100 live sites for guest posts and contributions, with DR, DA and traffic.', kw: 'weight loss posting sites guest post sites write for us link building' },
    { slug: 'entrepreneurship-posting-sites', title: 'Entrepreneurship Posting Sites: 100 Places to Publish', desc: 'Entrepreneurship Posting Sites - 100 live sites for guest posts and contributions, with DR, DA and traffic.', kw: 'entrepreneurship posting sites guest post sites write for us link building' },
    { slug: 'latin-america-posting-sites', title: 'Latin America Posting Sites: 100 Places to Publish', desc: 'Latin America Posting Sites - 100 live sites for guest posts and contributions, with DR, DA and traffic.', kw: 'latin america posting sites guest post sites write for us link building' },
    { slug: 'nutrition-posting-sites', title: 'Nutrition Posting Sites: 100 Places to Publish', desc: 'Nutrition Posting Sites - 100 live sites for guest posts and contributions, with DR, DA and traffic.', kw: 'nutrition posting sites guest post sites write for us link building' },
    { slug: 'high-traffic-posting-sites', title: 'High-Traffic Sites Posting Sites: 100 Places to Publish', desc: 'High-Traffic Sites Posting Sites - 100 live sites for guest posts and contributions, with DR, DA and traffic.', kw: 'high-traffic sites posting sites guest post sites write for us link building' },
    { slug: "photography-posting-sites", title: "Photography Posting Sites: 100 Places to Publish", desc: "100 live photography sites for guest posts, tutorials and portfolio features, with DR, DA and traffic.", kw: "photography posting sites photo guest post sites write for us tutorials gear reviews petapixel fstoppers link building" },
    { slug: "travel-posting-sites", title: "Travel Posting Sites: 100 Places to Publish", desc: "100 live travel sites for guest posts, destination features and points-and-miles content, with DR, DA and traffic.", kw: "travel posting sites travel guest post sites write for us destination blogs points and miles nomadic matt link building" },
    { slug: "southeast-asia-posting-sites", title: "Southeast Asia Posting Sites: 100 Places to Publish", desc: "100 live Southeast Asian news, business, tech and travel sites for guest posts, with DR, DA and traffic.", kw: "southeast asia posting sites thailand indonesia philippines malaysia singapore vietnam guest post sites tech in asia scmp link building" },
    { slug: "mexico-posting-sites", title: "Mexico Posting Sites: 100 Places to Publish", desc: "100 live Mexican news, business, culture and travel sites for guest posts, with DR, DA and traffic.", kw: "mexico posting sites mexican guest post sites colaboracion write for us el universal milenio expansion link building" },
    { slug: "mommy-posting-sites", title: "Mommy Posting Sites: 100 Places to Publish", desc: "100 live mom, parenting and pregnancy sites for guest posts and contributions, with DR, DA and traffic.", kw: "mommy posting sites mom blog guest post sites parenting write for us pregnancy babycenter scary mommy link building" },
    { slug: "home-posting-sites", title: "Home Posting Sites: 100 Places to Publish", desc: "100 live home decor, interior design, DIY and real-estate sites for guest posts and contributions, with DR, DA and traffic.", kw: "home posting sites interior design decor guest post sites diy home improvement write for us houzz apartment therapy link building" },
    { slug: "celebrity-posting-sites", title: "Celebrity Posting Sites: 100 Places to Publish", desc: "100 live celebrity, entertainment and pop-culture sites for guest posts and contributions, with DR, DA, traffic and Spam Score.", kw: "celebrity posting sites entertainment guest post sites pop culture music film write for us people variety link building" },
    { slug: "canada-posting-sites", title: "Canada Posting Sites: 100 Places to Publish for Canadian Readers", desc: "100 live Canadian news, business, city and lifestyle sites for guest posts and contributions, with DR, DA and traffic.", kw: "canada posting sites canadian guest post sites write for us cbc globe and mail blogto daily hive link building" },
