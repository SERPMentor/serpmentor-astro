...
const STATIC_PATHS = [
  ...
  { path: "/seo/backlinks/gadget-posting-sites", priority: "0.7", changefreq: "monthly" },
  ...
  { path: "/seo/backlinks/mommy-posting-sites", priority: "0.7", changefreq: "monthly" },
  ...
  { path: "/seo/backlinks/affiliate-marketing-posting-sites", priority: "0.7", changefreq: "monthly" },
  { path: "/seo/backlinks/yoga-posting-sites", priority: "0.7", changefreq: "monthly" },
  { path: "/seo/backlinks/social-media-posting-sites", priority: "0.7", changefreq: "monthly" },
  { path: "/seo/backlinks/forex-posting-sites", priority: "0.7", changefreq: "monthly" },
  { path: "/seo/backlinks/cryptocurrency-posting-sites", priority: "0.7", changefreq: "monthly" },
  { path: "/seo/backlinks/weight-loss-posting-sites", priority: "0.7", changefreq: "monthly" },
  { path: "/seo/backlinks/entrepreneurship-posting-sites", priority: "0.7", changefreq: "monthly" },
  { path: "/seo/backlinks/latin-america-posting-sites", priority: "0.7", changefreq: "monthly" },
  { path: "/seo/backlinks/nutrition-posting-sites", priority: "0.7", changefreq: "monthly" },
  { path: "/seo/backlinks/high-traffic-posting-sites", priority: "0.7", changefreq: "monthly" },
